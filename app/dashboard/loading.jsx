  ...
  return (
     <div className="space-y-5 animate-pulse">
      ...
      {[...Array(4)].map((_, i) => (
        <div 
          key={i} 
          className="bg-[#11151c] p-7 rounded-2xl border border-white/5 shadow-xl"
        >

          {/* Icon */}
          <div className="mb-5 p-3 bg-white/5 w-fit rounded-xl">
      ...
      <div className="block xl:hidden space-y-3">
        {[...Array(5)].map((_, i) => (
          <div key={i} className="bg-[#11151c] border border-white/5 rounded-xl p-4 space-y-3">
