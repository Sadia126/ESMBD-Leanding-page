    ...
    <nav className="sticky top-0 z-50 bg-black/85 backdrop-blur-2xl border-b border-white/8 shadow-2xl shadow-black/40">
      <div className="flex items-center justify-between px-[4%] py-3">
        ...
        <Link href="/" className="flex items-center gap-3 shrink-0">
          <div className="w-11 h-11 bg-gradient-to-br from-gray-700 to-gray-900 rounded-2xl flex items-center justify-center border border-white/10 shadow-lg shadow-black/50">
