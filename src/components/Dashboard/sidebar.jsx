    ...
    <div className="h-full bg-[#11151c] border-r border-white/5 flex flex-col overflow-y-auto">
      ...
      <div className="p-8 mb-4">
        <Link href="/dashboard" className="flex items-center gap-3 group">
          ...
          <div className="w-10 h-10 bg-gradient-to-br from-[#1e232d] to-[#080808] rounded-xl flex items-center justify-center border border-white/10 shadow-xl group-hover:border-[#d4af37]/50 transition-all duration-300 shrink-0">
          ...
          <div className="flex flex-col">
            <div className="text-sm font-black leading-tight tracking-tighter">
              <span className="text-white block">EASY</span>
